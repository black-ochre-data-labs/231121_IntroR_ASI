...
```{r}
genes <- c("FOXP3", "IL2RA", "CXCR2")
```

5. Load the `RealTimeData.xlsx` file, renaming the first column (as before). Extract the timepoint from the first column, ensuring that "h" is always lower case.
