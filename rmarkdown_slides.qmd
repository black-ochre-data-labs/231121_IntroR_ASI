...
knitr::opts_chunk$set(
  results = 'hide', fig.show = "asis", fig.width = 6
)
```
...
`# Introduction to R, Nov 22nd 2023`
...
`**All material**` can be found at \[the course homepage\]\(http://blackochrelabs.au/231121_IntroR_ASI/\)
...
1. Import `transport` with all corrections
2. Describe the data using \`r `nrow(transport)`\`
